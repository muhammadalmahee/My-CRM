...
// If the user is not logged in (no user_id in SESSION), or their role is not 'super_admin',
...
<body>
    ...
    $dashboardFile = 'super_admin_dashboard.php';
    include 'sidebar.php';
?>
    ...
    <div class="main-content">
        ...
        if(isset($conn)){ //  Only run DB queries if a connection is available
            ...
            //  Users table: total count, active/inactive split, count per role
            ...
            //  Companies and Contacts tables: get total row counts
            ...
            //  Deals table: total deals, cumulative value (SUM), won and lost counts
            ...
            //  Tasks table: total count, breakdown by status (To-Do / In-Progress / Done),
            //    and overdue count (past due date and not yet Done)
            ...
            //  Campaigns table: total count, active count, planning count
            ...
            //  Fetch the 5 most recent deals, 4 most recent tasks, and 4 most recently added users
        ...
        //    str_replace converts 'super_admin' → 'Super Admin' for display
        ...
        <div id="mainDashboardContent">
            ...
            <div class="ov-heading">
                <div class="ov-heading-left">
                    <h1>CRM Overview</h1>
                    <!--  Logged-in user's name pulled from SESSION; falls back to 'Super Admin' if not set -->
            ...
            <div class="ov-mid-row">
                ...
                <div class="ov-panel">
                    ...
                    //  Query deal counts grouped by stage, then update the $stages array
                ...
                <div class="ov-panel">
                    ...
                    <?php foreach([
                        ...
                        ['Super Admin','super_admin','#ede9fe','#8b5cf6','fa-user-shield',1], // Super Admin count is always 1
